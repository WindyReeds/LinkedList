...
Deletes the object and its pointer //
...
A destructor was not necessary because //
There would be no compiler error, instead it would result in a memory leak during runtime.
